...
import com.thespeakers_studio.thespeakersstudioapp.activity.EditPresentationActivity;
...
public class ListItemLocationPromptView extends ListItemPromptView implements
    ...
    protected void renderViews() {
        ...
        */
        ...
        if (getContext() instanceof EditPresentationActivity) {
            ((EditPresentationActivity) getContext()).addLocationCallback(this);
        }
